...
<div class="surface-section px-4 py-2 md:px-6 lg:px-8">
    ...
    <div class="grid text-center">
        ...
        <div class="col-12 md:col-4 lg:col-3 xl:col-2">
            ...
            <div class="text-xl text-900 font-medium mb-2">Tobaishe (Fari) 🦍</div>
            <div class="text-blue-600 mb-5">Alguien dele chamba</div>
        </div>
        <div class="col-12 md:col-4 lg:col-3 xl:col-2">
            <img src="/images/chucho.png" height="150px" class="mb-3" />
            <div class="text-xl text-900 font-medium mb-2">Tobalá (Chuy Ramos) 🐶</div>
            <div class="text-blue-600 mb-5">Tiene problemas de ego</div>
        </div>
        <div class="col-12 md:col-4 lg:col-3 xl:col-2">
        ...
        <div class="col-12 md:col-4 lg:col-3 xl:col-2">
            ...
            <div class="text-xl text-900 font-medium mb-2">Espadín (Jajir) 🐁</div>
            <div class="text-blue-600 mb-5">Pregúntele si chambea</div>
        </div>
        <div class="col-12 md:col-4 lg:col-3 xl:col-2">
